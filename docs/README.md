...
| [guide/connect-agentboard-to-chatgpt.md](guide/connect-agentboard-to-chatgpt.md) | Exposing the read-only API to a private GPT — human-gated, read this fully first |
...
**Supported browsers:** current Chrome/Edge, Firefox, and Safari 16.4+. Approvo
...
| [plan/01-product-and-scope.md](plan/01-product-and-scope.md) | What Approvo is and isn't, and how it compares |
...
as an Approvo project and `context/` is a live context pack.
