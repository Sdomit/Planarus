...
ROUTER_PLANES: list[tuple[object, str, Plane, str]] = [
    ...
    (entity_connections, "connections", Plane.TENANT, ""),
    (docs, "docs", Plane.TENANT, ""),
    (mentions, "mentions", Plane.TENANT, ""),
    (context_pack, "context-pack", Plane.TENANT, ""),
    (git, "git", Plane.TENANT, ""),
    (fs, "fs", Plane.LOCAL_CONTROL, "P12d folder picker; control-token gated inside, 409s in team mode, lists directory names only"),
